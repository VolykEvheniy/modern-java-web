...
public class UnpinActivityCommand implements Command {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        ActivityReceiver.getInstance().unpinActivity(user.getId(), UUID.fromString(userId), UUID.fromString(activityId));
