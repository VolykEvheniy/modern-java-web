...
public class PinActivityCommand implements Command {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        ActivityReceiver.getInstance().pinActivity(user.getId(), UUID.fromString(userId), UUID.fromString(activityId));
